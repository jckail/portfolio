resume_data = {
    ...
    "skills": {
        ...
        "Amazon Web Services (AWS)": ["EMR", "SageMaker", "S3", "Redshift", "Glue", "MWAA", "RDS", "Kinesis", "Firehose", "DynamoDB", "Bedrock", "SNS"],
        "Google Cloud Platform (GCP)": ["BigQuery", "Compute Engine", "Dataflow", "AutoML", "Vertex AI Studio", "PubSub", "Cloud Run", "Looker", "Firebase"],
        "Web Development": ["Docker", "Kubernetes", "FastAPI", "Flask", "Django", "Svelte", "React", "Node.js", "HTML", "GraphQL", "Gin", "Retool"]
    },
    "achievements": [
        {
            "title": "TechCrunch - \"Join Group via QR\"",
            "description": "Pitched, designed and implemented the functionality to enable Facebook group admins to invite users to their groups by generating a QR Code. Used by millions of users daily. Tech Crunch - https://shorturl.at/SRszb"
        },
        {
            "title": "Jobbr - AI Agent Job Matching",
            "description": "Created a custom AI agent that matches a resume to available jobs at tech companies. Using Python, Langchain, FastAPI and OpenAI. https://github.com/jckail/Jobbr"
        },
        {
            "title": "Developed \"pointup.io\"",
            "description": "An AI web app for \"All of your loyalty points in one place,\" powered by a Selenium-WebDriver agent in AWS via elastic beanstalk, lambda, and s3. https://www.pointup.io/ https://github.com/jckail/point_bot"
        },
        {
            "title": "Algorithmic Crypto Trading Project",
            "description": "Created crypto trading algorithm via scraped crypto, NASDAQ, and CPME rare minerals data. On AWS Sage maker via BOTO3, Django, pandas, and beautiful soup. https://github.com/jckail/crypto_trader"
        },
        {
            "title": "goPilot",
            "description": "CLI tool to help build applications written in GO https://github.com/jckail/goPilot"
        }
    ]
}