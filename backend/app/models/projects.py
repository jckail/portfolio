projects = {
    ...
    "jobbr": {
        ...
        "description_detail": """Developed Jobbr, an AI-powered web application that transforms recruitment by matching job postings with candidates' skills and resumes for greater efficiency and accuracy.
Leveraged GPT-4 and Anthropic’s Claude to parse job postings from raw HTML into structured JSON, aligning job descriptions with resumes using advanced NLP techniques.
Integrated SQLModel and SQLAlchemy for efficient data management, with Alembic migrations to ensure smooth database updates and version control.
Deployed the platform using Docker to maintain consistent environments and follow DevOps best practices.
Implemented a FastAPI-based modular API with private endpoints, Supabase authentication, and AI-powered role parsing and URL scraping to promote code reusability and scalability.
Used LangChain for document embedding and similarity analysis, enhancing job matching precision with advanced AI capabilities.
Followed CI/CD workflows with comprehensive testing to ensure code reliability and seamless deployments.
Prioritized security through token management, Supabase authentication, and password hashing with Python-JOSE and Passlib, alongside email validation to ensure strong user management.
...
Tech Stack: Python 3.9+, FastAPI, SQLAlchemy, Pydantic, Supabase, Docker""",
    ...
    "pointup": {
        ...
        "description_detail": """Created PointUp, a loyalty management tool designed to centralize and optimize points from credit cards, airlines, and hotel programs.
Engineered a backend system using Python and Selenium for web scraping, overcoming anti-bot protections with NordVPN IP rotation and human behavior simulation.
Deployed the system on AWS EC2 with secure data storage in S3, ensuring scalability and reliability.
Integrated Auth0 for user authentication and encrypted sensitive data, ensuring secure handling of user credentials.
...
Demonstrated expertise in Python development, cloud infrastructure, and secure web scraping through a real-world solution.""",
    ...
    "lit_crypto": {
        ...
        "description_detail": """Developed a Python-based data analysis tool to collect, process, and analyze real-time cryptocurrency data from APIs (CryptoCompare, CoinMarketCap, Alpha Vantage).
Engineered a multithreaded data ingestion system to efficiently handle multiple data sources and ensure low-latency processing.
Leveraged AWS services (S3, Glue, Athena) to create a scalable cloud-native architecture capable of handling large datasets.
...
Highlighted problem-solving and financial technology expertise, navigating API integration challenges and delivering actionable insights into cryptocurrency trends.""",
    ...
    "go_pilot": {
        ...
        "description_detail": """Built GoPilot, a next-generation CLI tool to enhance development workflows and accelerate mastery of Go programming.
Integrated GPT-4 for code insights and debugging, transforming the CLI into an intelligent development companion.
Designed a modular system combining Go, Python, and Bash to manage file operations, context updates, and automated testing workflows.
Implemented golangci-lint and Go’s native testing framework to streamline linting and testing operations.
...
Demonstrated proficiency in Go, Bash scripting, and AI-enhanced development, showcasing innovative problem-solving and productivity enhancement.""",
    ...
    "data_playground": {
        ...
        "description_detail": """Developed a data-driven e-commerce platform mimicking real-world e-commerce workflows, focusing on analytics, API development, and data pipelines.
Used PostgreSQL for data management and FastAPI for asynchronous API development to enable seamless backend operations.
Implemented Docker-based containerization for smooth deployment and independent service scaling.
Designed efficient data partitioning (hourly and daily) to optimize querying and ensure scalability under heavy workloads.
